...
namespace Projeto_Casa_Criancas.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,descricao,colaboradorID")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,descricao,colaboradorID")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
