...
namespace Projeto_Casa_Criancas.Controllers
{
    ...
    public class ColaboradoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,cnpj,endereco,celular")] Colaborador colaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,cnpj,endereco,celular")] Colaborador colaborador)
        {
