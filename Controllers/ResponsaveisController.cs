...
namespace Projeto_Casa_Criancas.Controllers
{
    ...
    public class ResponsaveisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,celular")] Responsavel responsavel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,celular")] Responsavel responsavel)
        {
